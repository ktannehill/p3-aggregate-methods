...
class Student:
    ...
    # aggregate mathod to determine how many courses a student is in
    def course_count(self):
        return len(self._enrollments)

    # aggregate method assuming we have a grade attribute to get average of all grades in enrollments
...
class Enrollment:
    ...
    # aggregate method to determine how many enrollments were done for any day students were enrolled
    @classmethod
